...
<template>
  ...
  >
    ...
    <InputText
      ...
      :disabled="disabled"
      :dir="inputDir"
      class="input input-bordered w-full !h-8 !min-h-0 py-1.5 px-2.5 text-xs font-light leading-snug placeholder:text-[0.65em] placeholder:font-light placeholder:text-text-muted dark:placeholder:text-text-secondary"
    ...
    <Textarea
      ...
      :rows="rows"
      :dir="inputDir"
      class="textarea textarea-bordered w-full !min-h-0 py-1.5 px-2.5 text-xs font-light leading-snug placeholder:text-[0.65em] placeholder:font-light placeholder:text-text-muted dark:placeholder:text-text-secondary"
