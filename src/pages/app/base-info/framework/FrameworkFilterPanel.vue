...
import FrameworkFilterAutoApply from './FrameworkFilterAutoApply.vue';
...
const { t } = useI18n();
const formKey = ref(0);
const formId = 'framework-filter-form';
    ...
    >
      ...
      <div class="grid grid-cols-1 gap-3 md:grid-cols-1">
        <BaseInput
          name="title"
          compact-label
          :label="t('framework.filter-field-title')"
        />
      </div>
    </Form>
  </div>
