            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400">
                  {{ tree.length }} {{ tree.length === 1 ? t('settings-page.category-count-singular') : t('settings-page.category-count-plural') }}
                </p>
              </div>
            </div>
            <Button
        ...
        <div class="p-6">
          ...
          >
            ...
            <p class="mt-1 text-xs text-slate-400 dark:text-slate-500">
              {{ t('settings-page.category-empty-hint') }}
            </p>
          </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    <Lucide v-else icon="FileText" class="h-4 w-4 text-slate-400 dark:text-slate-500" />
                  </div>
                    ...
                    <li>
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <Lucide v-else icon="FileText" class="h-3.5 w-3.5 text-slate-400 dark:text-slate-500" />
                        </div>
