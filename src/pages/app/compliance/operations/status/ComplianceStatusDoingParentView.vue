...
import { getProgressExecutorLabel } from '../complianceStatusHelpers';
...
const referrerDisplay = computed(() => getProgressExecutorLabel(props.row));
</script>
...
<template>
  <div class="mt-4 border-t border-slate-200 pt-3 dark:border-darkmode-600">
    ...
    >
      {{ t('compliance-page.doing-parent-body') }}
    </p>
    <div
    ...
    >
      ...
      >
        {{ t('compliance-page.doing-parent-referrer-label') }}
      </p>
      <p
