...
const pillars = computed(() => dashboardPayload.value?.pillars.reverse() ?? []);
        ...
        <div class="overflow-x-auto border-b border-slate-200/80 pb-3 dark:border-darkmode-600">
          <div class="flex w-full gap-2">
            <button
              ...
              :key="pillar.key"
              type="button"
              class="inline-flex  w-full items-center gap-2 rounded-lg border px-4 py-2 text-sm font-semibold transition"
