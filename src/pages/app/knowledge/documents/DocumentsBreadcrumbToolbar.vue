...
<template>
  <div class="relative flex flex-shrink-0 flex-wrap items-center gap-1.5" dir="ltr">
    ...
    <button
      ...
      :aria-label="t('documents.toolbar-add')"
      :title="t('documents.toolbar-add')"
      @click="onAdd?.()"
    >
    ...
    <button
      ...
      :aria-label="t('documents.toolbar-export')"
      :title="t('documents.toolbar-export')"
      @click="onExport?.()"
    >
    ...
    <div class="flex shrink-0 items-center gap-1">
      <button
        ...
        :aria-label="t('documents.toolbar-filter')"
        :title="t('documents.toolbar-filter')"
        @click="onFilter?.()"
      >
      ...
      <button
        ...
        :aria-label="t('documents.toolbar-clear-filters')"
        :title="t('documents.toolbar-clear-filters')"
        @click="onClearFilters?.()"
      >
        <span class="truncate">{{ t('documents.toolbar-clear-filters') }}</span>
      </button>
    </div>
  </div>
</template>
