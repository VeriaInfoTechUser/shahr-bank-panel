...
<template>
  <div class="relative flex flex-shrink-0 flex-wrap items-center gap-1.5" dir="ltr">
    <button
      ...
      :aria-label="t('prompts.toolbar-add')"
      :title="t('prompts.toolbar-add')"
      @click="onAdd?.()"
    >
    ...
    <button
      ...
      :aria-label="t('prompts.toolbar-export')"
      :title="t('prompts.toolbar-export')"
      @click="onExport?.()"
    >
    ...
    <div class="flex shrink-0 items-center gap-1">
      <button
        ...
        :aria-label="t('prompts.toolbar-filter')"
        :title="t('prompts.toolbar-filter')"
        @click="onFilter?.()"
      >
      ...
      <button
        ...
        :aria-label="t('prompts.toolbar-clear-filters')"
        :title="t('prompts.toolbar-clear-filters')"
        @click="onClearFilters?.()"
      >
        <span class="truncate">{{ t('prompts.toolbar-clear-filters') }}</span>
      </button>
    </div>
  </div>
</template>
