...
import {orderStatusList} from "@/utils/variables.ts";
import {FormTextarea} from "@/base-components/Form/index.ts";
import BaseCard from "@/base-components/Card/BaseCard.vue";
import Dropzone from "@/base-components/Dropzone/index.ts";
import {getCookie} from "@/utils/cookie.ts";
import {base_url, uri} from "@/constants/config.js";
import {generateUniqueInt} from "@/composables/utility.js";
...
const emit = defineEmits(['cancel', 'onSuccess', 'onError']);
...
<template>
  <Form @submit="onSubmit" :validation-schema="validationSchema">
    ...
    <div class="flex col-md-12 mt-4 items-end justify-end gap-2">
      <Button variant="outline-secondary" @click="cancel" size="sm" class=" shadow-md justify-end items-end">
        {{ $t('button.cancel') }}
      </Button>
      <Button variant="primary" size="sm" type="submit" class=" shadow-md justify-end items-end">
