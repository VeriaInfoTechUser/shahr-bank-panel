    ...
    <template v-else>
      <div class="mb-5 flex items-center justify-between">
        <span class="flex items-center gap-1 text-xs font-semibold text-slate-600 dark:text-slate-300">
          {{ t('risk-task.answer-options-label') }}
      ...
      <div class="space-y-4">
        ...
        >
          <p class="mb-1.5 flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-[0.06em] text-slate-400 dark:text-slate-500">
            ...
            {{ t('risk-task.answer-control-description') }}
          </p>
        ...
        <div v-if="answerOptionsView.length" class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            >
              ...
              {{ t('risk-task.answer-select-hint') }}
            </span>
          </div>
            ...
            >
              ...
              <div class="relative flex shrink-0 items-center justify-center">
                <svg width="42" height="42" viewBox="0 0 40 40" class="-rotate-90">
                  <circle cx="20" cy="20" r="16" fill="none" stroke-width="3.5" class="stroke-slate-200 dark:stroke-white/10" />
                  <circle
        ...
        <BaseInput
          ...
          :label="t('risk-task.answer-note-label')"
          :placeholder="t('risk-task.answer-note-placeholder')"
        />
      </div>
    </template>
...
:deep(.glass-panel) {
  ...
  box-shadow: 0 8px 32px rgba(15, 23, 42, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.4);
}
