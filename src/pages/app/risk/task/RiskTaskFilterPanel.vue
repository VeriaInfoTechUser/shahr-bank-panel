...
import RiskTaskFilterAutoApply from './RiskTaskFilterAutoApply.vue';
import RiskTaskDomainCleanup from './RiskTaskDomainCleanup.vue';
...
const { t } = useI18n();
const formKey = ref(0);
const formId = 'risk-task-filter-form';
...
<template>
  <div>
    <Form
      ...
      as="div"
    >
      <RiskTaskFilterAutoApply
        :build-payload="buildPayload"
        @apply="onAutoApply"
      />
      <RiskTaskDomainCleanup
      ...
      <div class="grid grid-cols-1 gap-3">
        <BaseInput
          name="title"
          compact-label
          :label="t('risk-task.filter-field-title')"
        />
        <BaseMultiSelect
          name="frameworkSlug"
          compact-label
          :label="t('risk-task.filter-field-framework')"
        ...
        <BaseMultiSelect
          name="domainSlug"
          compact-label
          :label="t('risk-task.filter-field-domain')"
