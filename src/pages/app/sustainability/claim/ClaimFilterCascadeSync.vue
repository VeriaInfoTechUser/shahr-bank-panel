...
export type ClaimFilterParents = CascadeFilterParents;

const emit = defineEmits<{
  (e: 'parents', parents: ClaimFilterParents): void;
}>();
...
function snapshot(): ClaimFilterParents {
  return {
...
let prev: ClaimFilterParents | null = null;
